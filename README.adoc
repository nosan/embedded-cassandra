...
this interface to start and stop `Cassandra`, however if you are looking for something useful for testing, you should
 use `TestCassandra` from `embedded-cassandra-test` module.
