...
@EmbeddedLocalCassandra(scripts = "/cql-scripts/*.cql"/*, version = , ... */ )
...
@SpringBootTest
@RunWith(SpringRunner.class)
@EmbeddedLocalCassandra(scripts = "classpath:init.cql", replace = EmbeddedCassandra.Replace.NONE /* use auto-configured cluster. */)
