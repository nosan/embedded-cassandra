...
/**
 * The supplier which returns path to {@code java.io.tmpdir} directory.
 *
 * @author Dmytro Nosan
 * @since 4.0.0
 */
public final class TemporaryDirectorySupplier implements Supplier<Path>, IOSupplier<Path> {
