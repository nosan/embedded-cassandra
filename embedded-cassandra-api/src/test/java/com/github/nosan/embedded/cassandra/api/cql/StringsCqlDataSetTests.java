...
/**
 * Tests for {@link StringCqlScript} and {@link CqlDataSet}.
 *
 * @author Dmytro Nosan
 */
class StringsCqlDataSetTests {

	private final CqlDataSet dataSet = CqlDataSet.ofStrings("CREATE TABLE test.users ( id text PRIMARY KEY )");
