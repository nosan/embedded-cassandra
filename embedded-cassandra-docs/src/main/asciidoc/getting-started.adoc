...
[[getting-started-pull-request-checklist]]
...
[[getting-started-quck-start]]
== Quick Start

[[getting-started-system-requirements]]
=== System Requirements

Embedded Cassandra {project-version} requires https://www.java.com[Java 8]
...
NOTE: The first start can take a while because Apache Casandra has to be initialized.
Default implementation downloads and extracts an archive just once and then using it to initialize Apache Cassandra each time.
