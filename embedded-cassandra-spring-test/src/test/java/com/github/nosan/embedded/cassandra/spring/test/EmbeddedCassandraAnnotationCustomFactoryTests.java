...
/**
 * Tests for {@link EmbeddedCassandra} with a custom {@link CassandraFactory}.
 *
 * @author Dmytro Nosan
 */
@EmbeddedCassandra
...
class EmbeddedCassandraAnnotationCustomFactoryTests {

	private final Cassandra cassandra;

	EmbeddedCassandraAnnotationCustomFactoryTests(@Autowired Cassandra cassandra) {
