 ...
 * versions. This customizer is registered by default. Customizer removes all `--X:` jvm
 * options from the `jvm.options` and `-Xloggc` from `cassandra-env.sh/ps1` files.
 *
 * @author Dmytro Nosan
 */
public final class JavaCompatibilityCustomizer implements FileCustomizer {
	...
	private static final class EnvironmentCompatibilityCustomizer
		...
		@Override
		protected String process(String line, File file, Distribution distribution) {
			return (!line.contains("-Xloggc") ? line : "");
